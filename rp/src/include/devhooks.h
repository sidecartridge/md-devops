 ...
 *              drive the firmware without its own services (the HTTP server,
 *              for example). tools/dev/swd.py is the host side.
 */
...
#define devhooks_setAppHandler(handler) ((void)(handler))
